      ...
      passengerManager_(passengerManager)
{
    ...
    userNameLabel_ = new QLabel("Xin chào, ...", sidebar_);
    ...
    stack_->addWidget(searchBookPage_);
    stack_->addWidget(agentBookingsPage_);
    stack_->addWidget(new AccountsPage(accountManager_, this));
    stack_->addWidget(ticketsReportPage_);
    stack_->addWidget(revenueReportPage_);
