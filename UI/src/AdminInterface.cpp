      ...
      passengerManager_(passengerManager)
{
    ...
    userNameLabel_ = new QLabel("Xin chào, Admin", sidebar_);
    ...
    stack_->addWidget(new FlightRulesPage(flightManager_, this));
    stack_->addWidget(new PromotionsPage(this));
    stack_->addWidget(new AdminTicketsReportPage(accountManager_, bookingManager_, reportManager_, this));
    stack_->addWidget(new AdminRevenueReportPage(accountManager_, bookingManager_, reportManager_, this));
    stack_->addWidget(new AccountsPage(accountManager_, this));
    stack_->addWidget(new AgentListPage(accountManager_, this));
