...
namespace UI
{
    ...
    LoginState::LoginState(App &app)
        : State(app),
          mFontRegular(app.getFont("Mulish-Regular")), // Lấy font từ App
          mFontBold(app.getFont("Mulish-Bold"))
    {
        initUI();
    }
    ...
    void LoginState::initUI()
    {
        ...
        // Tiêu đề
        mTitleText.setFont(mFontBold); // Dùng font Mulish Bold
        ...
        // Labels
        mUsernameLabel.setFont(mFontRegular); // Dùng font Mulish Regular
        ...
        mLoginButton.setText("Login", mFontBold, 20); // Dùng Mulish Bold cho nút
