...
#include <memory>
#include "../../../src/UI/AdminInterface.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AdminInterface_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AdminInterface_t qt_meta_stringdata_AdminInterface = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_AdminInterface[] = {
...
Q_CONSTINIT const QMetaObject AdminInterface::staticMetaObject = { {
    ...
    qt_meta_stringdata_AdminInterface.offsetsAndSizes,
...
void AdminInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AdminInterface::logoutClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AdminInterface::logoutClicked()
{
