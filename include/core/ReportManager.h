...
//     // // --- Thống kê & Báo cáo riêng cho Agent ---
//     // AgentSelfReport generateSelfReport(const std::string& agentId,
//     //                                 const std::string& startDate,
//     //                                 const std::string& endDate) const;

//     // std::vector<double> getMonthlyRevenueByAgent(const std::string& agentId, int year) const;

//     // int getBusinessTicketsInRangeByAgent(const std::string& agentId,
//     //                                     const std::string& startDate,
//     //                                     const std::string& endDate) const;

//     // int getEconomyTicketsInRangeByAgent(const std::string& agentId,
//     //                                     const std::string& startDate,
//     //                                     const std::string& endDate) const;
