...
private:
    std::string instanceId;     // ID nội bộ duy nhất, định dạng: <FlightNumber>-<YYYYMMDD>
    std::string flightId;       // Khóa ngoại, tham chiếu tới Flight gốc
    std::string flightNumber;   // Mã chuyến bay công khai (VD: "VN123")
...
public:
    ...
    // Constructor chính: Tự động sinh ID từ flightNumber và departureDate.
