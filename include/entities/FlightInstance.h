...
private:
    std::string instanceId;     // ID duy nhất theo format: <FlightNumber>-<YYYYMMDD>
    std::string flightId;       // Khóa ngoại, tham chiếu tới Flight gốc
    std::string flightNumber;   // Số hiệu chuyến bay công khai (VD: "VJ153")
...
public:
    ...
    // Constructor chính: Tự động sinh ID theo format <FlightNumber>-<YYYYMMDD>
